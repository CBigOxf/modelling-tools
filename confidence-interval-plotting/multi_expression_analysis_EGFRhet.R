...
melted$variable = gsub("count.objects.with..kind....Cell.....total", "", melted$variable)
melted$variable = gsub("count.objects.with...kind....Gene..and.label....EGFR..and.my.active...EGFR", "", melted$variable)
